...
import ibm_db
import bcrypt
conn = ibm_db.connect("DATABASE=service credentials-1;HOSTNAME=;PORT=;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=jrb90969;PWD=fjQBEpzl9hENhxGb",'','')
